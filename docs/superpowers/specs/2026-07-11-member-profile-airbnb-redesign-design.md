...
- LinkedIn button moves to the top-right of the card (same row as avatar, `justify-content: space-between`), unchanged behavior/visibility rule (`linkedinUrl` present).
