                ...
                return (
                  <div className="ai-result" key={`${sIdx}-${i}`}>
                    ...
                    <div className="ai-result-body">
                      <div className="ai-result-type mono" style={{color: kindColor[r.kind]}}>{r.kind}</div>
      ...
      <div className="container-wide">
        <div className="hero-center">
          <div className="hero-eyebrow">
            <span className="eyebrow">Global Network · Est. 2024</span>
          </div>
          <h1 className="display">
            Verified finance & legal counsel,<br/>
          ...
          <div className="hero-search">
            ...
            <div className="hero-search-input">
              ...
              />
              <button className="btn btn-primary">Find experts <span className="arr">→</span></button>
            </div>
            <div className="hero-search-hints">
              <span className="mono">TRY</span>
              <button onClick={()=>setQuery('M&A tax · Chennai')}>M&A tax · Chennai</button>
              <button onClick={()=>setQuery('Cross-border compliance')}>Cross-border compliance</button>
              <button onClick={()=>setQuery('IP counsel · EU')}>IP counsel · EU</button>
            </div>
          </div>
      ...
      <div className="container-wide">
        <div className="ai-section-grid">
          <div className="ai-section-text">
            ...
            <a href="members.html" className="btn btn-primary btn-lg" style={{marginTop:32}}>Try Expertly AI <span className="arr">→</span></a>
          </div>
      ...
      <div className="container-wide">
        <div className="masthead">
          <div className="masthead-left mono">
            ...
            <div>{(new Date()).toLocaleDateString('en-GB', { day:'2-digit', month:'long', year:'numeric'}).toUpperCase()}</div>
          </div>
    ...
    <section className="section split-section">
      <div className="container-wide">
        <div className="split-feature reverse reveal">
          <div className="split-panel split-panel-sky">
            <MarqueePanel
              items={areas}
              rowCount={3}
              speeds={[44, 52, 48]}
              renderItem={(p) => (
                <a href={`members.html?practice=${encodeURIComponent(p.name)}`} className="m-pill">
                  <span className="m-pill-icon mono">{p.icon}</span>
                  <span className="m-pill-name">{p.name}</span>
                  <span className="m-pill-count mono">{p.count}</span>
                </a>
              )}
            />
          </div>
          <div className="split-text">
            <span className="eyebrow">Section 02 · Coverage</span>
    ...
    <section className="section split-section">
      <div className="container-wide">
        <div className="split-feature reveal">
          <div className="split-text">
            <span className="eyebrow">Section 03 · Our network</span>
          ...
          <div className="split-panel split-panel-mint">
            <MarqueePanel
              items={members}
              rowCount={3}
              speeds={[40, 50, 44]}
              renderItem={(m) => (
                <a href={`members.html#${m.id}`} className="m-chip">
                  ...
                  <div className="m-chip-body">
                    ...
                    <div className="m-chip-role">{m.practice}</div>
                  </div>
                </a>
              )}
            />
    ...
    <section className="section articles-section">
      <div className="container-wide">
        <div className="section-head-row">
          <div>
            <span className="eyebrow">Section 04 · Knowledge base</span>
  ...
  return (
    <section className="section events-section">
      <div className="container-wide">
        <div className="section-head-row">
          <div>
            <span className="eyebrow">Section 05 · Calendar</span>
            ...
            <a href={`events.html#${e.id}`} key={e.id} className="event-card">
              ...
              <div className="event-body">
                ...
                <div className="event-foot">
                  <span className="mono">📍 {e.city.toUpperCase()}, {e.country.toUpperCase()}</span>
...
function Testimonials() {
  ...
  return (
    <section className="section testimonials">
      <div className="container-wide">
        <div className="section-head">
          <span className="eyebrow">Section 07 · Voices</span>
              ...
              <figure className="testimonial-card" key={i}>
                ...
                <figcaption>
                  ...
                  <div>
                    ...
                    <div className="mono t-meta">{member.title.toUpperCase()} · {member.location.split(',')[0].toUpperCase()}</div>
                  </div>
                </figcaption>
              </figure>
            );
...
function DualCTA() {
  return (
    <section className="section dual-cta">
      <div className="container-wide">
        <div className="section-head">
          <span className="eyebrow">Section 08 · Two ways in</span>
      ...
      <div className="container-wide">
        <div className="faq-grid">
          <div className="faq-left">
            <span className="eyebrow">Section 09 · Questions</span>
            <h2 className="section-title" style={{marginTop:16}}>Common questions.</h2>
            <p className="lede" style={{marginTop:20, maxWidth:360}}>Still curious? Email us at <a href="mailto:contact@expertly.global" style={{color:'var(--accent)',textDecoration:'underline'}}>contact@expertly.global</a> — we reply within one business day.</p>
          </div>
          <div className="faq-right">
            {groups.map((g, gi) => (
              <div key={gi} className="faq-group">
                <h4 className="mono">{g.g.toUpperCase()}</h4>
                {g.items.map((item, ii) => {
                  const id = `g${gi}-q${ii}`;
